...
export default function AddCourseScreen() {
    ...
    useEffect(() => { AsyncStorage.getItem('theme').then(t => { if (t) setTheme(t); }); loadUser(); }, []);
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.bg }]}>
            <View style={[styles.header, { backgroundColor: colors.card, borderBottomColor: colors.border }]}>
                ...
                <Text style={[styles.headerTitle, { color: colors.text }]}>Nouveau cours</Text>
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                <TouchableOpacity onPress={pickImage} style={[styles.imagePicker, { backgroundColor: colors.inputBg, borderColor: colors.border }]} activeOpacity={0.7}>
                    {image ? (
                        <View style={styles.imagePreviewContainer}>
                            ...
                            <TouchableOpacity style={styles.removeImageBtn} onPress={() => setImage(null)}><FontAwesome5 name="times-circle" size={24} color={colors.danger} /></TouchableOpacity>
                        </View>
                    ) : (
                ...
                <View style={[styles.formCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
                    <View style={styles.formGroup}>
                        ...
                        <View style={[styles.inputWrapper, { backgroundColor: colors.inputBg, borderColor: colors.border }]}>
                            ...
                            <TextInput style={[styles.input, { color: colors.text }]} placeholder="Ex: Mathématiques générales" placeholderTextColor={colors.textSec} value={title} onChangeText={setTitle} maxLength={100} />
                        </View>
                    </View>
                    ...
                    <View style={styles.formGroup}>
                        ...
                        <View style={[styles.inputWrapper, { backgroundColor: colors.inputBg, borderColor: colors.border }]}>
                            ...
                            <TextInput style={[styles.input, { color: colors.text }]} placeholder="Ex: Dr. Mukendi" placeholderTextColor={colors.textSec} value={professor} onChangeText={setProfessor} />
                        </View>
                    </View>
                    ...
                    <View style={styles.formGroup}>
                        ...
                        <View style={[styles.textareaWrapper, { backgroundColor: colors.inputBg, borderColor: colors.border }]}>
                            <TextInput style={[styles.textarea, { color: colors.text }]} placeholder="Décrivez brièvement ce cours..." placeholderTextColor={colors.textSec} value={description} onChangeText={setDescription} multiline numberOfLines={4} textAlignVertical="top" maxLength={500} />
                        </View>
                ...
                <TouchableOpacity style={[styles.submitBtn, { backgroundColor: colors.primary }]} onPress={handleCreateCourse} disabled={loading} activeOpacity={0.8}>
                    {loading ? <ActivityIndicator color="#fff" /> : <View style={styles.submitBtnContent}><FontAwesome5 name="plus-circle" size={16} color="#fff" /><Text style={styles.submitBtnText}> Créer le cours</Text></View>}
                </TouchableOpacity>
